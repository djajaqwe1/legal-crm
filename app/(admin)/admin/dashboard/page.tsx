  ...
  return (
    <CrmShell pageContext={`Дашборд. Активных дел: ${activeCases.length}, клиентов: ${clients.length}, договоров: ${contracts.length}, срочных дедлайнов: ${upcomingDeadlines}.`}>
      ...
      <div className="flex flex-wrap gap-2 mb-6">
        ...
        <Link href="/admin?preset=daily_routine&run=1" className="inline-flex items-center gap-1.5 rounded-full border border-emerald-200 dark:border-emerald-800 bg-emerald-50 dark:bg-emerald-900/20 px-4 py-2 text-xs font-medium text-emerald-700 dark:text-emerald-300 hover:bg-emerald-100 transition-colors">
          📋 Мой рабочий день
        </Link>
