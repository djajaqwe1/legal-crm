...
5. create/update/add_task/update_task/checklist/generate_document — объясни что сделаешь; система запросит «Разрешаете?» у юриста. Задачи можно менять (название, срок, время, телефон в названии) через update_task — НИКОГДА не говори что CRM не умеет обновлять задачи.
